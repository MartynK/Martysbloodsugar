...
A linear model was fitted with the following idea:
 - A circadian cycle was fitted with a small degree-of-freedom natural spline
 - Time since the last event was modelled with an additional spline on top of the circadian rythm
...
mod_notes_matrix <- model.matrix( ~ notes : bs( note_time_scaled, 
